					...
					<div class="col-lg-7">
						<div class="card shadow-lg border-0 rounded-lg mt-5">
							<div class="card-header">
								<h3 class="text-center font-weight-light my-4">Sửa Sản
									Phẩm</h3>
								<div class="card-body">
									<form:form action="Product/Update/${id}.htm" modelAttribute="product"
										...
										<div class="form-row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="small mb-1">Giá Bán</label>
													<form:input class="form-control" placeholder="product.sellingPrice"
														path="sellingPrice" />
