					...
					<div class="col-lg-5">
						<div class="card shadow-lg border-0 rounded-lg mt-5">
							<div class="card-header">
								<h3 class="text-center font-weight-light my-4">Thêm Nhà
									Cung Cấp</h3>
								<div class="card-body">
									<form:form action="Supplier/Insert.htm" modelAttribute="supplier">
										<div class="form-group">
											<label class="small mb-1">Tên Nhà Cung Cấp</label>
											<form:input class="form-control"
												placeholder="Nhập Tên Nhà Cung Cấp" path="name" />
											<form:errors class="redtext" path="name" />
										</div>
										<div class="form-group">
											<label class="small mb-1">Email</label>
											<form:input class="form-control" placeholder="Nhập Email"
												path="email" />
										...
										<div class="form-group">
											...
											<form:input class="form-control"
												placeholder="Nhập Số Điên Thoại" path="phoneNumber" />
											<form:errors class="redtext" path="phoneNumber" />
										</div>
										<div class="form-group">
											<label class="small mb-1">Địa Chỉ</label>
											<form:input class="form-control" placeholder="Nhập địa chỉ"
												path="address" />
